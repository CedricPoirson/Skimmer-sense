...
void setup()
{
  ...
  Serial.println();
  Serial.println("========================================");
  Serial.println(" SkimmerSense Zigbee all reports test");
  Serial.println(" TEMP + LOW + HIGH");
  Serial.println("========================================");
  ...
  Serial.println("All reports test OK");

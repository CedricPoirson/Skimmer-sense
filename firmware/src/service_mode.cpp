...
.batterybox{padding:18px;border-radius:16px;background:rgba(2,13,22,.34);border:1px solid var(--line);margin-bottom:16px}.batteryhead{display:flex;justify-content:space-between;align-items:flex-start;gap:16px}.batteryhead>strong{font-size:34px;line-height:1}.batterystate{font-size:18px;font-weight:800;margin-top:5px}.batterytrack{height:13px;background:#061722;border-radius:99px;overflow:hidden;margin:15px 0}.batterytrack span{display:block;height:100%;border-radius:inherit;background:linear-gradient(90deg,var(--cyan),var(--blue));transition:width .5s}.batteryfacts{display:grid;grid-template-columns:repeat(4,1fr);gap:8px}.batteryfacts div{padding:10px;background:rgba(255,255,255,.035);border-radius:10px}.batteryfacts span{display:block;color:var(--muted);font-size:11px}.batteryfacts b{display:block;margin-top:4px;font-size:14px}.batterybox.good .batterystate{color:var(--green)}.batterybox.warning .batterystate{color:var(--amber)}.batterybox.critical .batterystate{color:var(--red)}.batterybox.good .batterytrack span{background:linear-gradient(90deg,#20c981,var(--cyan))}.batterybox.warning .batterytrack span{background:linear-gradient(90deg,#ff914d,var(--amber))}.batterybox.critical .batterytrack span{background:linear-gradient(90deg,#f04458,var(--red))}

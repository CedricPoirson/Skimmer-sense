...
- **Current firmware:** v0.9.12 production candidate

## Current status

Firmware **v0.9.12** is a production candidate. The established sensing, Zigbee and deep-sleep paths are hardware-validated; the reinforced battery telemetry still requires validation on the current prototype. Active development, SERVICE-mode diagnostics and Wi-Fi OTA are available on [`feature/service-mode-ota`](https://github.com/CedricPoirson/Skimmer-sense/tree/feature/service-mode-ota).
